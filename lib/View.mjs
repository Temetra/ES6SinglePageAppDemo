...
var View = class {
	constructor(rootFragment, eventMappings = null, ...contentFilters) {
		...
		if (eventMappings && typeof eventMappings[0] !== 'undefined') {
			let isEventMapping = (eventMappings[0] instanceof EventMapping)
			console.log(isEventMapping)
		}
		if (typeof contentFilters[0] !== 'undefined') console.log(typeof contentFilters[0])
	}
