...
var L10N = class {
	...
	static async localise(func) {
		...
		await cachedFetch(`res/localisation.${lang}.json`)
	...
	// Can be used in a ViewTemplate render promise chain to localise rendered content before adding to DOM
...
// Wraps text with a <localise> element, for later replacement by localiseView
function L(text) {
